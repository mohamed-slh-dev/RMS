@extends('layouts.companies-login')
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="" class="dropdown-item active d-flex align-items-center">
                        ...
                        <div class="avatar avatar-sm mr-8pt">
                            ...
                            <span class="avatar-title rounded bg-accent">CO</span>

                        </div>

                        <small class="ml-4pt flex">
                            <span class="d-flex flex-column">
                                <strong class="text-black-100">Companies</strong>
                                <span class="text-black-50">Login As Delivery Company</span>
                            </span>
                        </small>
                    </a>
                </div>
                ...
                <div class="col-12 col-lg-8 offset-lg-2 py-3 bg-white"
                    ...
                    <div class="row px-5  pb-4 pt-3">
                        <div class="col-sm-12 text-center mb-3">
                            ...
                            <p class="mb-2 text-info text-center" style="font-weight: 500; font-size:15; letter-spacing: 1px;">(COMPANIES LOGIN)</p>
                        </div>


                    <form action="{{route('company.login.check')}}" method="POST" class="col-12 p-0 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <p class="text-right mt-3"><a href="#" class="small"
                                        style="color:black; font-weight:500; text-decoration: underline;">Forgot your password?</a></p>
                            </div>
