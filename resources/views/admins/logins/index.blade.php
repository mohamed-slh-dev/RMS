...
<div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
    <div class="mdk-drawer-layout__content page-content"
        style="background-image: url('{{ asset('assets/admin/images/bgs/healthy-food-background-U5A6RT9.jpg') }}') !important; background-size: cover;">
        ...
        <div class="navbar navbar-expand navbar-shadow px-0  pl-lg-16pt navbar-light bg-body" id="default-navbar"
            ...
            <a href="index.html" class="navbar-brand">
                <img class="navbar-brand-icon mr-0 pl-0" src="{{ asset('assets/admin/images/logo/RMS.png') }}">
            ...
            <div class="dropdown border-left-2 navbar-border">
                ...
                <a href="{{route('kitchen.login')}}" class="dropdown-item d-flex align-items-center">
        ...
        <div class=" pt-32pt pt-sm-64pt pb-32pt px-0 px-lg-5 bg-image-login">
                    ...
                    <div class="row px-5 pb-4 pt-3">
                        ...
                        <div class="col-sm-12 text-center mb-3">
                            ...
                            <p class="mb-2 text-info text-center"
                                style="font-weight: 500; font-size:15; letter-spacing: 1px;">(ADMIN)</p>
                        </div>


                    <form action="{{route('admin.login.check')}}" class="col-12 p-0 mx-auto" method="POST">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <p class="text-right mt-3"><a href="reset-password.html" class="small"
